...
import { addQuiz, selectQuiz, updateQuiz } from "../quizReducer";
...
function QuizEditor() {
    ...
    const handleSave = async (e: React.SyntheticEvent<any>) => {
        e.preventDefault();
        if (quizId === "new") {
            await api.createQuiz(courseId, quiz)
        ...
        console.log("Saving Quiz successful!");
    ...
    return (
        <div className="container-fluid d-flex flex-column">
            ...
            <form onSubmit={(e) => handleSave(e)}>
                ...
                <div className="row mb-3  align-items-center">
                    <label className="col-4 col-form-label text-end">Quiz Group</label>
                    <div className="col-6">
                        <select className="form-select" value="QUIZZES">
                                    ...
                                    <div className="ms-3">
                                        ...
                                        <div className="input-group">
                                            <input
                                                ...
                                                onChange={(e) => dispatch(selectQuiz({
                                                    ...quiz, availableUntil: e.target.value
                                                }))} />
                                            <i className="input-group-text fa-regular fa-calendar-days"></i>
                                        </div>
                                    </div>
                ...
                <div className="d-flex flex-row">
                    ...
                    <div className="ms-auto">
                        <Link to={`/Kanbas/Courses/${courseId}/Quizzes`} className="btn btn-outline-secondary me-1">Cancel</Link>
